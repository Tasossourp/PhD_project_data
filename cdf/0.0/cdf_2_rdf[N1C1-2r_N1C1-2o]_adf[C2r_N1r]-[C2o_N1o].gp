...
s_title = ""
# X axis title
s_xtitle = "[N1C1-2r\\_N1C1-2o] Distance / pm"
# Y axis title
s_ytitle = "[C2r\\_N1r]-[C2o\\_N1o] Angle / Degree"
...
splot "cdf_2_rdf[N1C1-2r_N1C1-2o]_adf[C2r_N1r]-[C2o_N1o].gp.csv" matrix using ($2*8+204):($1*1.8+0.9):3
...
set output "cdf_2_rdf[N1C1-2r_N1C1-2o]_adf[C2r_N1r]-[C2o_N1o].png"
...
splot "cdf_2_rdf[N1C1-2r_N1C1-2o]_adf[C2r_N1r]-[C2o_N1o].gp.csv" matrix using ($2*8+204):($1*1.8+0.9):(f_plot($3))
...
splot "cdf_2_rdf[N1C1-2r_N1C1-2o]_adf[C2r_N1r]-[C2o_N1o].gp.csv" matrix using ($2*8+204):($1*1.8+0.9):(s_contour ? f_plot($3) : 1/0) with lines linewidth 0.15*s_contourscale linecolor rgbcolor "black" nosurface
...
set output "cdf_2_rdf[N1C1-2r_N1C1-2o]_adf[C2r_N1r]-[C2o_N1o]_box.png"
